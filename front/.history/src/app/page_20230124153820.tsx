...
// fetch films from Strapi
  ...
  return (
    ...
    <main className='bg-black h-[100vh]'>
     ...
     return   <div className="p-2 movie-card rounded-sm text-white border">
          <div className="card-header">
            <Image width={200} height={200} src={'https://img.yts.mx/assets/images/movies/Captain_America_The_Winter_Soldier_2014/medium-cover.jpg'} alt='movie'/>
          </div>
