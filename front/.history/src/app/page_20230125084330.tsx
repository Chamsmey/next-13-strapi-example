    ...
    <>
      ...
      <main className="bg-black">
        <div className="banner">
          <Image className="w-full fixed z-[-1]" width={1500} height={1000} src="https://cnbl-cdn.bamgrid.com/assets/60c53d45f6f0546647ddd4e006a207c713d149586cea401fdc0152f2fa9263a6/original" alt="banner"/>
