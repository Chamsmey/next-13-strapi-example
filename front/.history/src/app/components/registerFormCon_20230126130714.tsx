  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto mt-10 rounded md:w-1/4 border p-2 bg-white grid grid-rows-3">
      ...
      <div className="mt-4 row-span-1">
          ...
          <input
            className="block px-1 py-2 rounded-sm outline outline-1 outline-offset-0 outline-gray-300 sm:text-sm bg-white/10 backdrop-blur-sm"
...
<input
            className="block px-1 py-2 rounded-sm w-full outline outline-1 outline-offset-0 outline-gray-300 sm:text-sm bg-white/10 backdrop-blur-sm"
