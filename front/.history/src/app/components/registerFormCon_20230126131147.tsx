  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto mt-10 rounded md:w-1/4 border p-2 bg-white grid grid-rows-3">
      ...
      <div className="mt-4 row-span-1 grid grid-cols-2 gap-1">
          ...
          <input
            className="block px-1 py-2 col-span-1 rounded-sm outline outline-1 outline-offset-0 outline-gray-300 sm:text-sm bg-white/10 backdrop-blur-sm"
...
<input
      ...
      <div className="mt-2">
        <button type="submit" className="w-full py-1 rounded-sm text-white text-md bg-indigo-600">
          Submit
        </button>
      </div>
    </form>
