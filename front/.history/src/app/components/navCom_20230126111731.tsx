    ...
    <header className="">
      <nav className="flex justify-between py-2 px-1">
        ...
        <div className="px-2 flex text-white">
          {!user ? (
            <button className="p-2 rounded bg-clip-border text-transparent transition duration-700 hover:bg-gradient-to-r from-blue-500 to-teal-400 text-lg text-white">
              LogIn
            </button>
          ) : (
            <button
