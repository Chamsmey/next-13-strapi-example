      ...
      <header className="bg-black">
        <nav className="flex justify-between py-2 px-1">
          ...
          <ul className="px-2 flex text-white">
            <li className="p-2 rounded bg-clip-border text-transparent bg-gradient-to-r from-blue-500 to-teal-400 text-lg">Sign In</li>
           
          </ul>
        </nav>
      </header>
      <main className="bg-black">
        <div className="banner fixed z-[-1] top-0">
