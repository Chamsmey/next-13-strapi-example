    ...
    <>
      ...
      <main className="bg-black h-[100vh]">
        <div className="banner">
          <Image width={1500} height={1000} src="https://cnbl-cdn.bamgrid.com/assets/60c53d45f6f0546647ddd4e006a207c713d149586cea401fdc0152f2fa9263a6/original" alt="banner"/>
